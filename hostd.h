...
// alterações são feitas nessa parte
...
unsigned int timerLimit = 15; // tempo limite definido para o dispatch que trata dos processos que deixaram de usar a cpu por muito tempo
